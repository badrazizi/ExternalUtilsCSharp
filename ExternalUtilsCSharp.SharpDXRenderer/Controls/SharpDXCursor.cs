...
namespace SharpDXRenderer.Controls
{
    public class SharpDXCursor : SharpDXControl
    {
        ...
        public override void Draw(SharpDXRenderer renderer)
        {
            ...
            Vector2 left = SharpDXConverter.Vector2EUCtoSDX(ExternalUtilsCSharp.MathUtils.RotatePoint(
                            SharpDXConverter.Vector2SDXtoEUC(right),
                            SharpDXConverter.Vector2SDXtoEUC(center),
                            Angle));

            right = SharpDXConverter.Vector2EUCtoSDX(ExternalUtilsCSharp.MathUtils.RotatePoint(
                            SharpDXConverter.Vector2SDXtoEUC(right),
                            SharpDXConverter.Vector2SDXtoEUC(center),
                            AngleRotation));
            left = SharpDXConverter.Vector2EUCtoSDX(ExternalUtilsCSharp.MathUtils.RotatePoint(
