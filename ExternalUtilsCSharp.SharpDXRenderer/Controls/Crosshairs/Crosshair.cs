...
namespace SharpDXRenderer.Controls.Crosshairs
{
    public class Crosshair : SharpDXControl
    {
        ...
        protected void DrawLine(SharpDXRenderer renderer, Vector2 center, float distance, float length, float angle, float width, bool outline)
        {
            ...
            ExternalUtilsCSharp.MathObjects.Vector2 vecRotateA = new ExternalUtilsCSharp.MathObjects.Vector2(vecCenter.X + distance, vecCenter.Y);
            ExternalUtilsCSharp.MathObjects.Vector2 vecRotateB = new ExternalUtilsCSharp.MathObjects.Vector2(vecCenter.X + distance + length, vecCenter.Y);
        ...
        {
            ExternalUtilsCSharp.MathObjects.Vector2 vecCenter = SharpDXConverter.Vector2SDXtoEUC(center);
            ExternalUtilsCSharp.MathObjects.Vector2 vecRotateA = new ExternalUtilsCSharp.MathObjects.Vector2(vecCenter.X + length, vecCenter.Y);
            ExternalUtilsCSharp.MathObjects.Vector2 vecRotateB = new ExternalUtilsCSharp.MathObjects.Vector2(vecCenter.X, vecCenter.Y + length);
            vecRotateA += new ExternalUtilsCSharp.MathObjects.Vector2(distance, distance);
            vecRotateB += new ExternalUtilsCSharp.MathObjects.Vector2(distance, distance);
            vecRotateA = ExternalUtilsCSharp.MathUtils.RotatePoint(vecRotateA, vecCenter, angle);
            vecRotateB = ExternalUtilsCSharp.MathUtils.RotatePoint(vecRotateB, vecCenter, angle);
            Vector2 _vecRotateA = SharpDXConverter.Vector2EUCtoSDX(vecRotateA);
            Vector2 _vecRotateB = SharpDXConverter.Vector2EUCtoSDX(vecRotateB);
