...
namespace SharpDXRenderer.Controls
{
    ...
    {
        #region VARIABLES
        private ExternalUtilsCSharp.UI.UIObjects.Color color;
        ...
        public ExternalUtilsCSharp.UI.UIObjects.Color Color
        {
        ...
        {
            this.color = new ExternalUtilsCSharp.UI.UIObjects.Color(0, 0, 0, 0);
            ...
            this.Color = new ExternalUtilsCSharp.UI.UIObjects.Color(1f, 1f, 1f, 1f);
        }
        ...
        {
            this.Color = new ExternalUtilsCSharp.UI.UIObjects.Color(A.Value, R.Value, G.Value, B.Value);
        }
        ...
        public override void ApplySettings(ExternalUtilsCSharp.ConfigUtils config)
        {
            if (this.Tag != null)
                if (config.HasKey(this.Tag.ToString()))
                    this.Color = ExternalUtilsCSharp.UI.UIObjects.Color.FromFormat(config.GetValue<uint>(this.Tag.ToString()), ExternalUtilsCSharp.UI.UIObjects.Color.ColorFormat.RGBA);
        }
        #endregion
    }
}
